...
export function Header() {
    ...
    return (
        <header className={cn(
            ...
            scrolled
                ? "bg-white/80 dark:bg-zinc-950/80 backdrop-blur-xl border-b border-orange-500/10 shadow-sm py-2"
                : "bg-transparent py-4"
        )}>
                ...
                <div className="flex items-center gap-8">
                    <Link href={paths.home()} className="flex items-center gap-3 group px-2 py-1 rounded-2xl hover:bg-orange-500/5 transition-all">
                        ...
                        <div className="flex flex-col -space-y-1">
                            <span className="font-black text-2xl tracking-tighter bg-gradient-to-r from-orange-600 via-orange-500 to-amber-500 bg-clip-text text-transparent uppercase">
                                Interview
                            </span>
                            <span className="text-[10px] font-black uppercase tracking-[0.4em] text-muted-foreground/80 pl-1">
                                Academy
                            </span>
                        </div>
                    </Link>
