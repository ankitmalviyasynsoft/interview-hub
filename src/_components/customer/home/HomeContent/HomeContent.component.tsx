            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6">
                ...
                <div className="mb-16 pt-8 sm:pt-16 text-center space-y-8">
                    ...
                    <div className="space-y-4 max-w-4xl mx-auto">
                        ...
                        <p className="text-lg sm:text-2xl text-muted-foreground font-medium max-w-2xl mx-auto leading-tight pt-4">
                            Master the industry's toughest questions from top-tier companies with full explained solutions.
                        </p>
                    </div>
                ...
                <div className="space-y-6 sm:space-y-8 max-w-4xl mx-auto">
                    <div className="flex items-center justify-between mb-4">
                        <h2 className="text-xl font-black uppercase tracking-widest flex items-center gap-2">
                            Curated Content
                            <span className="inline-flex items-center justify-center min-w-8 h-6 px-2 rounded-lg bg-primary text-primary-foreground text-[10px] font-bold">
                    ...
                    {displayedQuestions.length > 0 ? (
                        ...
                        <div className="flex flex-col items-center justify-center py-32 bg-card/50 backdrop-blur-sm rounded-3xl border-2 border-dashed border-border/40 shadow-inner group">
                            ...
                            <Button
                                variant="default"
                                size="lg"
                                className="px-10 h-12 rounded-xl font-black uppercase tracking-widest text-xs"
                                ...
                                <PaginationItem>
                                    <PaginationPrevious
                                        ...
                                        className={cn(
                                            ...
                                            currentPage === 1 ? "pointer-events-none opacity-30" : "cursor-pointer hover:bg-primary hover:text-primary-foreground"
                                        )}
                                    />
                                </PaginationItem>
