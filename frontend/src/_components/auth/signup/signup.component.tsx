                    ...
                    <div className="space-y-1.5">
                        ...
                        <div className="relative">
                            <select
                                id="role"
                                {...register("role")}
                                className={`w-full px-4 py-3 rounded-xl bg-secondary border border-transparent focus:bg-background focus:border-ring focus:ring-2 focus:ring-ring/20 outline-none transition-all duration-200 text-foreground appearance-none cursor-pointer ${errors.role ? "border-red-500 focus:border-red-500" : ""
                                    }`}
                            >
